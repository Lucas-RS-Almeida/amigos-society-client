...
interface IGoalkeeperPageProps {
  $onBackToHome: () => void;
}
...
export function GoalkeeperPage({ $onBackToHome }: IGoalkeeperPageProps) {
        ...
        (Object.values(body).length === 0) ? (
          <>
            <header className="text-center">
              <span className="font-bold">Você selecionou a categoria: Goleiro</span>
            </header>
